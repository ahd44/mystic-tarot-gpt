...
export async function POST(req: Request) {
    ...
    if(question.trim() === "") {
        question = "How do I find what I'm looking for?"; //provides some clarification to the AI if the question field is blank
    }
    if(bio.trim() === "") {
        bio = "I am a user visiting this website.";
    }
